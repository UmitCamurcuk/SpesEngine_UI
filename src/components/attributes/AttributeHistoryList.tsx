...
import AttributeHistoryItem from './AttributeHistoryItem';
import historyService, { History, HistoryApiParams } from '../../services/api/historyService';
import Button from '../ui/Button';

interface AttributeHistoryListProps {
  attributeId: string;
}

const AttributeHistoryList: React.FC<AttributeHistoryListProps> = ({ attributeId }) => {
  ...
  const fetchHistory = async () => {
    ...
    try {
      ...
      const result = await historyService.getEntityHistory(attributeId, params);
  ...
  }, [attributeId, pagination.page, pagination.limit]);
    ...
    <div>
      ...
      {historyItems.length === 0 ? (
        <div className="text-center py-8 bg-gray-50 dark:bg-gray-800 rounded-lg">
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Bu öznitelik için henüz işlem geçmişi kaydedilmemiş.</p>
        </div>
      ) : (
...
export default AttributeHistoryList; 