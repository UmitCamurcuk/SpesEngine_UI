...
export const TextTableDisplay: React.FC<TextAttributeProps> = ({ value }) => {
...
export const TextEditInput: React.FC<TextAttributeProps> = ({
  attribute,
  value,
  onChange,
  error,
...
export const TextDetailDisplay: React.FC<TextAttributeProps> = ({
  attribute,
  value,
  isEditing = false,
  onChange,
