...
interface RichTextAttributeProps {
  attribute: any;
  value: any;
...
export const RichTextTableDisplay: React.FC<RichTextAttributeProps> = ({ value }) => {
  if (value === null || value === undefined || value === '') {
    return <span className="text-gray-400 italic">-</span>;
  }

  // HTML'i temizle ve sadece metni al
  ...
  return (
    <span className="text-sm truncate max-w-xs block" title={stripHtml(String(value))}>
...
export const RichTextEditInput: React.FC<RichTextAttributeProps> = ({
  attribute,
  value,
  onChange,
  error,
...
export const RichTextDetailDisplay: React.FC<RichTextAttributeProps> = ({
  attribute,
  value,
  isEditing = false,
  onChange,
