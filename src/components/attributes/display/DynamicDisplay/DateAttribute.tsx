...
export const DateTableDisplay: React.FC<DateAttributeProps> = ({ value }) => {
...
export const DateEditInput: React.FC<DateAttributeProps> = ({
  attribute,
  value,
  onChange,
  error,
...
export const DateDetailDisplay: React.FC<DateAttributeProps> = ({
  attribute,
  value,
  isEditing = false,
  onChange,
