...
export const NumberTableDisplay: React.FC<NumberAttributeProps> = ({ value }) => {
...
export const NumberEditInput: React.FC<NumberAttributeProps> = ({
  attribute,
  value,
  onChange,
  error,
...
export const NumberDetailDisplay: React.FC<NumberAttributeProps> = ({
  attribute,
  value,
  isEditing = false,
  onChange,
