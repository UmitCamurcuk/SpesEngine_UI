...
export const PhoneTableDisplay: React.FC<PhoneAttributeProps> = ({ value }) => {
...
export const PhoneEditInput: React.FC<PhoneAttributeProps> = ({
  attribute,
  value,
  onChange,
  error,
...
export const PhoneDetailDisplay: React.FC<PhoneAttributeProps> = ({
  attribute,
  value,
  isEditing = false,
  onChange,
