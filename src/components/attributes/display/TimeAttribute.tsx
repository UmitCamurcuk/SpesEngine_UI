...
export const TimeTableDisplay: React.FC<TimeAttributeProps> = ({ value }) => {
  ...
  return (
    <span className="text-sm">
      {new Date(`2000-01-01T${value}`).toLocaleTimeString('tr-TR', { 
        hour: '2-digit', 
        minute: '2-digit' 
      })}
    </span>
...
export const TimeEditInput: React.FC<TimeAttributeProps> = ({
  attribute,
  value,
  onChange,
  error,
...
export const TimeDetailDisplay: React.FC<TimeAttributeProps> = ({
  attribute,
  value,
  isEditing = false,
  onChange,
