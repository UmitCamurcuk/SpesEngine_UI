...
interface FormulaAttributeProps {
  attribute: any;
  value: any;
...
export const FormulaTableDisplay: React.FC<FormulaAttributeProps> = ({ value }) => {
...
export const FormulaEditInput: React.FC<FormulaAttributeProps> = ({
  attribute,
  value,
  onChange,
  error,
...
export const FormulaDetailDisplay: React.FC<FormulaAttributeProps> = ({
  attribute,
  value,
  isEditing = false,
  onChange,
