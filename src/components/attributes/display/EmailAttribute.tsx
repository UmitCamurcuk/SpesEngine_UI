...
export const EmailTableDisplay: React.FC<EmailAttributeProps> = ({ value }) => {
...
export const EmailEditInput: React.FC<EmailAttributeProps> = ({
  attribute,
  value,
  onChange,
  error,
...
export const EmailDetailDisplay: React.FC<EmailAttributeProps> = ({
  attribute,
  value,
  isEditing = false,
  onChange,
