...
export const ImageTableDisplay: React.FC<ImageAttributeProps> = ({ value }) => {
...
export const ImageEditInput: React.FC<ImageAttributeProps> = ({
  attribute,
  value,
  onChange,
  error,
...
export const ImageDetailDisplay: React.FC<ImageAttributeProps> = ({
  attribute,
  value,
  isEditing = false,
  onChange,
