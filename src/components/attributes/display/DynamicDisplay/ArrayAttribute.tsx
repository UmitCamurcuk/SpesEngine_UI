...
export const ArrayTableDisplay: React.FC<ArrayAttributeProps> = ({ value }) => {
...
export const ArrayEditInput: React.FC<ArrayAttributeProps> = ({
  attribute,
  value,
  onChange,
  error,
  ...
  const placeholder = getEntityDescription(attribute, currentLanguage) || `${getEntityName(attribute, currentLanguage)} girin (JSON array formatında)`;
...
export const ArrayDetailDisplay: React.FC<ArrayAttributeProps> = ({
  attribute,
  value,
  isEditing = false,
  onChange,
