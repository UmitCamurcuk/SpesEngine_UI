...
interface DateTimeAttributeProps {
  attribute: any;
  value: any;
...
export const DateTimeTableDisplay: React.FC<DateTimeAttributeProps> = ({ value }) => {
...
export const DateTimeEditInput: React.FC<DateTimeAttributeProps> = ({
  attribute,
  value,
  onChange,
  error,
...
export const DateTimeDetailDisplay: React.FC<DateTimeAttributeProps> = ({
  attribute,
  value,
  isEditing = false,
  onChange,
