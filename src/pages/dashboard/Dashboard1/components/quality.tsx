...
// Örnekler için veri kalitesi modülü içeriği
    ...
    <div className="w-full">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
        <div className="flex flex-col md:flex-row items-center justify-between mb-4">
          <div>
            <h2 className="text-lg font-medium text-gray-800 dark:text-white">Genel Veri Kalitesi Skoru</h2>
            <p className="text-sm text-gray-500 dark:text-gray-400">4 kategoride tüm ürünlerin kalite değerlendirmesi</p>
          </div>
        ...
        <div className="flex flex-col items-center justify-center">
          <div className="relative w-48 h-48 mb-6">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              <span className="text-5xl font-bold text-gray-800 dark:text-white">86</span>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full">
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-purple-600 dark:text-purple-400">78%</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          <h2 className="text-lg font-medium text-gray-800 dark:text-white mb-4">Kalite Trendleri</h2>
          <div className="h-72 bg-gray-50 dark:bg-gray-700 rounded flex items-center justify-center">
            <p className="text-gray-500 dark:text-gray-400">Bu alanda kalite trend grafiği gösterilecek</p>
          </div>
        </div>

        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          <h2 className="text-lg font-medium text-gray-800 dark:text-white mb-4">Kategori Karşılaştırması</h2>
          <div className="space-y-4">
            <div>
              <div className="flex justify-between mb-1">
                <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Elektronik</span>
            ...
            <div>
              <div className="flex justify-between mb-1">
                <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Mobilya</span>
            ...
            <div>
              <div className="flex justify-between mb-1">
                <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Giyim</span>
            ...
            <div>
              <div className="flex justify-between mb-1">
                <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Kozmetik</span>
            ...
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                <tr className="bg-white dark:bg-gray-800 border-b dark:border-gray-700">
                  <td className="px-6 py-4">Eksik ürün resimleri</td>
                ...
                <tr className="bg-white dark:bg-gray-800 border-b dark:border-gray-700">
                  <td className="px-6 py-4">Tutarsız fiyat verileri</td>
                  <td className="px-6 py-4">Mobilya</td>
                  <td className="px-6 py-4">
                    <span className="px-2 py-1 text-xs font-medium rounded-full bg-red-100 text-red-800 dark:bg-red-900/20 dark:text-red-400">Yüksek</span>
                  </td>
                  <td className="px-6 py-4">
                ...
                <tr className="bg-white dark:bg-gray-800 border-b dark:border-gray-700">
                  <td className="px-6 py-4">Yanlış kategori eşleştirmeleri</td>
                  <td className="px-6 py-4">Giyim</td>
                  <td className="px-6 py-4">
                ...
                <tr className="bg-white dark:bg-gray-800 border-b dark:border-gray-700">
                  <td className="px-6 py-4">Eksik ürün açıklamaları</td>
                  <td className="px-6 py-4">Kozmetik</td>
                  <td className="px-6 py-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-green-50 dark:bg-green-900/20 border border-green-100 dark:border-green-800 rounded-lg">
              <h3 className="text-sm font-medium text-green-800 dark:text-green-300 mb-2">Tüm ürünler için resim zorunluluğu</h3>
              <p className="text-xs text-green-700 dark:text-green-400">Ürün resimleri tamamlama oranının %82'den %100'e çıkarılması için tüm ürünlere resim zorunluluğu getirilmesi.</p>
            </div>
            <div className="p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 rounded-lg">
              <h3 className="text-sm font-medium text-blue-800 dark:text-blue-300 mb-2">Otomatik veri doğrulama kuralları</h3>
              <p className="text-xs text-blue-700 dark:text-blue-400">Fiyat ve stok bilgilerinin doğruluğunu artırmak için otomatik veri doğrulama kurallarının tanımlanması.</p>
            </div>
            <div className="p-4 bg-purple-50 dark:bg-purple-900/20 border border-purple-100 dark:border-purple-800 rounded-lg">
              <h3 className="text-sm font-medium text-purple-800 dark:text-purple-300 mb-2">Öznitelik standartlaştırması</h3>
              <p className="text-xs text-purple-700 dark:text-purple-400">Benzer özniteliklerin birleştirilmesi ve standart öznitelik kütüphanesinin oluşturulması.</p>
            </div>
          </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
        <div className="flex items-center mb-6">
          ...
          <div>
            <h2 className="text-lg font-medium text-gray-800 dark:text-white">Veri Kalitesi Hakkında</h2>
            <p className="text-sm text-gray-600 dark:text-gray-400">Veri kalitesi puanları nasıl hesaplanır?</p>
          </div>
        </div>
        <div className="pl-14">
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
            Veri kalitesi skorları, dört temel metriğin ağırlıklı ortalamasıdır:
          </p>
          <ul className="list-disc pl-5 text-sm text-gray-600 dark:text-gray-400 space-y-1 mb-4">
            <li><strong>Tamamlık:</strong> Gerekli tüm alanların doldurulma oranı</li>
            <li><strong>Doğruluk:</strong> Verilerin doğru formatta ve kabul edilebilir değer aralığında olması</li>
            <li><strong>Tutarlılık:</strong> Farklı veri kümeleri arasındaki ilişkilerin tutarlılığı</li>
            <li><strong>Güncellik:</strong> Verilerin güncel olma düzeyi ve güncelleme sıklığı</li>
          </ul>
