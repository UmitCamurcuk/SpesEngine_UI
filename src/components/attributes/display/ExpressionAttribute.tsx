...
interface ExpressionAttributeProps {
  attribute: any;
  value: any;
...
export const ExpressionTableDisplay: React.FC<ExpressionAttributeProps> = ({ value }) => {
...
export const ExpressionEditInput: React.FC<ExpressionAttributeProps> = ({
  attribute,
  value,
  onChange,
  error,
...
export const ExpressionDetailDisplay: React.FC<ExpressionAttributeProps> = ({
  attribute,
  value,
  isEditing = false,
  onChange,
