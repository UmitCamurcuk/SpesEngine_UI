...
import type { CreateItemDto } from '../../../services/api/itemService';
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
              Yeni bir öğe oluşturmak için aşağıdaki formu doldurun
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <label htmlFor="itemType" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                Öğe Tipi <span className="text-red-500">*</span>
              </label>
              <select
                id="itemType"
                name="itemType"
